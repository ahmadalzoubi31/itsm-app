...
const mockKBArticles: KBArticle[] = [
  {
    ...
    summary: 'Step-by-step guide to diagnose and resolve common email server issues including connectivity problems, authentication failures, and performance issues.',
    category: 'Email',
  ...
  },
  {
    ...
    summary: 'Complete guide for configuring SMTP settings, including port configurations, security protocols, and authentication methods.',
    category: 'Email',
  ...
  },
  {
    ...
    summary: 'How to monitor server performance, identify bottlenecks, and optimize system resources for better performance.',
  ...
  },
  {
    ...
    summary: 'Comprehensive guide to diagnose and resolve network connectivity problems affecting email and other services.',
    category: 'Network',
  ...
  },
  {
    ...
    summary: 'Methods to identify processes causing high CPU usage and steps to resolve performance degradation.',
...
const KnowledgeBaseSection = ({ incidentTitle, incidentDescription, incidentCategory }: KnowledgeBaseSectionProps) => {
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-center py-6">
            ...
            <p className="text-gray-500">No relevant articles found for this incident.</p>
          </div>
        </CardContent>
      </Card>
    )
    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        {relevantArticles.map((article) => (
          <div key={article.id} className="border-l-4 border-blue-200 pl-4 py-2">
            <div className="flex items-start justify-between mb-2">
              <h4 className="font-medium text-gray-900 leading-tight">{article.title}</h4>
