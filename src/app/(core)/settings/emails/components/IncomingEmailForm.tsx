...
export function IncomingEmailForm({ onSuccess }: IncomingEmailFormProps) {
  const { settings, loading, saving, saveSettings } = useIncomingEmailSettings();
  ...
  const removeEmailMapping = (index: number) => {
    const currentMappings = form.getValues("emailToIncidentMapping");
    form.setValue("emailToIncidentMapping", currentMappings.filter((_, i) => i !== index));
  };
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Configure email monitoring to automatically create incidents from incoming emails
        </CardDescription>
      </CardHeader>
              ...
              render={({ field }) => (
                <FormItem className="flex items-center justify-between rounded-lg border p-4">
                  <div className="space-y-0.5">
                    <FormLabel className="text-base">Enable Incoming Email Processing</FormLabel>
                    <FormDescription>
                      Monitor emails and automatically process them into incidents
                    </FormDescription>
                  </div>
                  <FormControl>
            ...
            {form.watch("enabled") && (
              <>
                <Alert>
                  ...
                  <AlertDescription>
                    Configure IMAP settings to monitor an email account for incoming messages. 
                    These emails will be processed according to your mapping rules.
                  </AlertDescription>
                </Alert>
                ...
                <div className="space-y-4">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem className="flex items-center justify-between rounded-lg border p-4">
                        <div className="space-y-0.5">
                          <FormLabel className="text-base">Auto-Create Incidents</FormLabel>
                          <FormDescription>
                ...
                <div className="space-y-4">
                  ...
                  {watchedMappings.length === 0 ? (
                    <div className="text-center p-8 border-2 border-dashed border-gray-300 rounded-lg">
                      ...
                      <p className="text-gray-600">No mapping rules configured</p>
                      <p className="text-sm text-gray-500">Add rules to automatically categorize incoming emails</p>
                    </div>
                  ) : (
                    <div className="space-y-4">
                            ...
                            <FormField
                              ...
                              render={({ field }) => (
                                <FormItem>
                                  ...
                                  <FormControl>
                                    <Input {...field} placeholder=".*urgent.*|.*critical.*" />
                                  </FormControl>
                                  <FormDescription>
                            ...
                            <FormField
                              ...
                              render={({ field }) => (
                                <FormItem>
                                  ...
                                  <FormControl>
                                    <Input {...field} placeholder=".*server.*down.*" />
                                  </FormControl>
                                  <FormDescription>
