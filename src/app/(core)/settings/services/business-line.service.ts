...
import { BUSINESS_LINE_ENDPOINTS } from "@/constants/api-endpoints/buisness-line.endpoints";
...
export async function deactivateBusinessLine(id: string): Promise<BusinessLine> {
