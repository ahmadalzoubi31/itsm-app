...
import { useRolesHook } from "../../roles/hooks/useRoles.hook";
...
const SideBarForm = ({
  ...
  // console.log("🚀 ~ SideBarForm ~ formData:", formData);
  ...
  const { roles: allRoles } = useRolesHook();
  ...
  const inheritedPermissions = useMemo(() => {
    return selectedRoleObjects.flatMap((role) => role.permissions || []);
  }, [selectedRoleObjects]);
