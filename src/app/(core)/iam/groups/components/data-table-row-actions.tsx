...
import { MoreHorizontal, Pencil, Trash, Shield, Users } from "lucide-react";
...
export function DataTableRowActions({ row }: GroupRowActionsProps) {
  ...
  const handleEdit = () => {
    router.push(`/iam/groups/edit/${group.id}`);
  };
      ...
      <AlertDialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This will permanently delete the group "{group.name}". This action
              cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
