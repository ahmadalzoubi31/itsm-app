...
export interface ServiceCard extends BaseEntity {
  name: string;
  description?: string;
...
export interface ServiceCardTemplate {
  id: string;
  name: string;
  description: string;
  category: string;
...
export interface ServiceCardValidation {
  isValid: boolean;
  errors: {
    field: string;
    message: string;
...
export interface ServiceCardWizardProps {
...
export interface ServiceCardBuilderProps {
  serviceCard?: ServiceCard;
  onSave: (serviceCard: Partial<ServiceCard>) => void;
  onCancel: () => void;
  isOpen: boolean;
...
export interface ServiceCardPreviewProps {
  isOpen: boolean;
  onClose: () => void;
  serviceCard: any;
}
